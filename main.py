...
class Draw:
    def __init__(self):
        self.x0, self.y0, self.a, self.w, self.walls, self.r = [None] * 6
...
class Game:
    ...
    def add_bullet(self, position):
        x, y = position
        self.bullets.append(Bullet(x, y, self.draw.r, 0, self.space))

    def draw_bullet(self, bullet):
        pos = bullet.body.position
        pos = pymunk.pygame_util.to_pygame(pos, self.screen)
        pg.draw.circle(self.screen, BULLET_COLOR, pos, self.draw.r)
